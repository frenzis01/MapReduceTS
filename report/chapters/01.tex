...
\begin{lstlisting}[language=bash, caption={Testing the dynamic topics implementation}]
   ...
   docker compose up
\end{lstlisting}
\note{This implementation is error prone. Error messages are displayed due to rebalancing, which is expected, but something else may happen under the hood which I couldn't figure out, leading to message duplication or other issues.}
